...
<ContentRef url="https://google.com">
...
<ContentRef url="https://google.com">Android Keystores</ContentRef>
...
<ContentRef url="#">Adding a Build Profile</ContentRef>
...
<ContentRef url="#">Build Profile Configuration Overview</ContentRef>
...
<ContentRef url="#">What are Workflows and How to Use Them?</ContentRef>
...
<ContentRef url="#">Testing Groups</ContentRef>
...
<ContentRef url="#">Send Apps to App Store Connect and TestFlight</ContentRef>

Send a binary to Google Play.

<ContentRef url="#">Send Apps to Google Play Console</ContentRef>

Send a binary to Huawei AppGallery.

<ContentRef url="#">Send Apps to Huawei AppGallery</ContentRef>
